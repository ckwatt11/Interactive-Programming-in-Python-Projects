#please run the program via the codeskulptor link provided
http://www.codeskulptor.org/#user43_oLb2WBGlyFbwMTW.py
...
def init():
    ...
    score1 = 0
    score2 = 0
    ball_init(0 == random.randint(0,10) % 2)
    pass
...
def draw(canvas):
    ...
    canvas.draw_text(str(score1), (190, 50), 40, "Green")
    canvas.draw_text(str(score2), (380, 50), 40, "Green")
...
frame.add_button("Restart Game", init, 100)
